\documentclass[PhD, ngerman, UKenglish, USenglish, Submit]{scrbook}
%------------------------------------------------------------------------------
\usepackage[texlive=2018]{uni-bonn-style/ubonn-thesis}

%\usepackage[texlive=2018]{uni-bonn-style/ubonn-biblatex}

\usepackage{uni-bonn-style/thesis_defs}
% \usepackage{listings}

% generate Texlive offlien version: 
%1. latex thesis.tex, then biber thesis // will generate thesis.bbl -- needed to render references.
%2. latex thesis makeglossaries thesis // will generate acronym
%3. latex thesis and then pdflatex thesis // in order to generate PDF
...
\newcommand*{\thesissubmit}{30.11.2019}
% \newcommand*{\thesissubmit}{Month 2015}
% Date of thesis examination (PhD)
\newcommand*{\thesispromotion}{ 17.12.2019}

%==============================================================================
\chapter{Scalable RDF querying} % via statistics-driven partitioning and ranking}
...
Currently, the Linked Open Data (LOD) cloud comprises more than 10\,000 datasets available online\furl{http://lodstats.aksw.org/} using the Semantic Web standards. 
...
To address these challenges, in this paper, we propose a scalable semantic-based distributed approach\furl{https://github.com/SANSA-Stack/SANSA-Query/tree/develop/sansa-query-spark/src/main/scala/net/sansa_stack/query/spark/semantic} for efficient evaluation of SPARQL queries over distributed RDF datasets. 
...
\begin{itemize}
 ...
 \item Integration with the SANSA~\cite{lehmann-2017-sansa-iswc}\furl{http://sansa-stack.net/} framework.
\end{itemize}
...
It consists of three main facets: Data Storage Model, SPARQL Query Fragments Translator, and Query Evaluator.
...
It walks through the SPARQL query (\textit{Step 4}) using the Jena ARQ\furl{https://jena.apache.org/documentation/query/} and iterate through clauses in the SPARQL query and bind the variables into the RDF data while fulfilling the clause conditions.
...
Besides simple BGP translation, our system supports \emphb{UNION}, \emphb{LIMIT} and \emphb{FILTER} clauses.
...
We keep the number of nodes constant i.e.\ 5 worker nodes and increase the size of the datasets to semantic-based-measure whether our approach deals with larger datasets.
...
~\\ \defn{Breakdown by SPARQL queries}

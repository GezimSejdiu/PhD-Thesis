...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        Support for Scalable \gls{RDF} Quality Assessment(see Chapter~\ref{chapter:dist_quality_assessment} for more details). 
        Support for ingestion of additional \gls{RDF} formats.
        ...
        Support for Scalable \gls{RDF} Dataset Statistics (see Chapter~\ref{chapter:dist_lod_stats} for more details).
        
        \item \textbf{SANSA v0.1} \textit{2016-12}:
        Initial SANSA release. 
        SANSA website and guidelines. 
        Support for reading and writing \gls{RDF} files in N-Triples format.
    \end{itemize}

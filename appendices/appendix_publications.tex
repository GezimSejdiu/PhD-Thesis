...
\item \emph{Miscellaneous Papers}
    ...
    \item  Lule Ahmedi; Lavdim Halilaj; \textbf{Gezim Sejdiu}; and Labinot Bajraktari, “\href{http://luleahmedi.uni-pr.edu/docs/pubs/SemAuthorRank2014.pdf}{Ranking Authors on the Web: A Semantic AuthorRank},” in Social Networks: Analysis and Case Studies, Gündüz-Öugüdücü and A. Etaner-Uyar, Eds., Vienna: Springer Vienna, 2014, pp. 19-40. \texttt{URL}:~\url{http://luleahmedi.uni-pr.edu/docs/pubs/SemAuthorRank2014.pdf}

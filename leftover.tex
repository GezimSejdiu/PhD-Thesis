...
% Aknowledgements
%The whole Semantic Web Community act as another source of inspiration and motivation for the thesis.
...
% Related Work -- statistics

Some earlier work on the \gls{RDF} statistics was done also by make-void\furl{https://github.com/cygri/make-void} and RDFStats~\cite{conf/dexaw/LangeggerW09}.
